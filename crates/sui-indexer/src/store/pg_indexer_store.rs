...
use crate::schema::{
    chain_identifier, checkpoints, display, epochs, events, feature_flags, objects, objects_history,
    objects_snapshot, packages, protocol_configs, pruner_cp_watermark, transactions, tx_calls, tx_changed_objects,
